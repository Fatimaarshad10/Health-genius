...
function Login() {
    ...
    return (
        ...
        <div className="flex justify-center items-center w-full h-full">
            <div className="flex flex-col lg:flex-row justify-center items-center w-11/12 lg:w-1/2 p-8 shadow-md ">
                <img src="/assets/img/plant.png" className="w-30 h-12 lg:w-32" alt="doctor_img" />
                <h1 className="text-3xl text-indigo-900 font-bold">Health
                    <span className="text-3xl font-bold text-black">Genius</span>
                </h1>
            </div>
        </div>
        <div className="flex flex-col justify-center items-center w-full h-full bg-indigo-200 text-center shadow-md rounded-md">
            ...
            <form className="max-w-md w-full p-4 mt-8">
                ...
                {errors && (
                    <div className="text-red-600 text-center">{errors.toString()}</div>
                )}
                <button
                    onClick={handleLogin}
                    disabled={isLoading}
                    className="mt-3 w-full rounded-lg bg-indigo-900 px-5 py-3 text-xl font-semibold text-white shadow-sm hover:border-2 hover:bg-white hover:text-indigo-900 hover:border-indigo-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-900">
