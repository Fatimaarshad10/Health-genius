            ...
            <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
                <div class="h-full px-3 py-4 overflow-y-auto bg-indigo-50 dark:bg-indigo-100">
                    <ul class="space-y-2 font-medium">
                        <li>
                            <Link to="/doctor/dashboard" class="flex items-center p-2 text-indigo-200 rounded-lg dark:text-white hover:bg-indigo-100 dark:hover:bg-indigo-500 group">
                        ...
                        <li>
                            <Link to="/doctor/dashboard/appointments" class="flex items-center p-2 text-indigo-200 rounded-lg dark:text-white hover:bg-indigo-100 dark:hover:bg-indigo-500 group">
                        ...
                        <li>
                            <Link to="/doctor/dashboard/reports" class="flex items-center p-2 text-indigo-200 rounded-lg dark:text-white hover:bg-indigo-100 dark:hover:bg-indigo-500 group">
                                <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
