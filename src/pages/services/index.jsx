    ...
    return (
            ...
            <div class="flex flex-col lg:flex-row lg:justify-between mb-10 mr-10 lg:ml-14 mt-8">
                <div class="flex flex-col items-center mb-4 lg:mb-0">
                    <div class="bg-white shadow-lg p-4 w-72 h-72">
                        <img src="src/assets/img/service-1.png" alt="service-1" class="w-56 h-56 mx-auto" />
                        <p class="text-center font-bold text-xs lg:text-sm mt-2">Top rated physicians</p>
                    </div>
                </div>
                <div class="flex flex-col items-center mb-4 lg:mb-0">
                    <div class="bg-white shadow-lg p-4 w-72 h-72">
                        <img src="src/assets/img/service-2.png" alt="service-2" class="w-56 h-56 mx-auto" />
                        <p class="text-center font-bold text-xs lg:text-sm mt-2">Orthopedic surgeons</p>
                    </div>
                </div>
                <div class="flex flex-col items-center mb-4 lg:mb-0">
                    <div class="bg-white shadow-lg p-4 w-72 h-72">
                        <img src="src/assets/img/service-3.png" alt="service-3" class="w-56 h-56 mx-auto" />
                        <p class="text-center font-bold text-xs lg:text-sm mt-2">Dermatologists</p>
                    </div>
                </div>
                <div class="flex flex-col items-center">
                    <div class="bg-white shadow-lg p-4 w-72 h-72">
                        <img src="src/assets/img/sevice-4.png" alt="service-4" class="w-56 h-56 mx-auto" />
        ...
        {/* Why Health Genius Section  */}
            ...
            justify-center">
                ...
                <div class="flex flex-col items-center mb-4 lg:mb-0">
                    <div class="bg-white shadow-lg p-4 w-72 h-80">
                        <img src="src/assets/img/genius-2.png" alt="genius-2" class="w-52 h-52 mx-auto" />
                ...
                <div class="flex flex-col items-center mb-4 lg:mb-0">
                    <div class="bg-white shadow-lg p-4 w-72 h-80">
                        <img src="src/assets/img/genius-3.png" alt="genius-3" class="w-52 h-52 mx-auto" />
