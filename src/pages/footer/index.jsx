                ...
                <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                    <div class="md:flex md:justify-between">
                        <div class="mb-6 md:mb-0">
                            ...
                            <p className="text-lg">build a better website for your healthcare and business today.</p>
                    ...
                    <div class="sm:flex sm:items-center sm:justify-between">
                        <span class="text-sm text-black sm:text-center dark:text-white">© 2024 <a href="#" class="hover:underline">Health Genius™</a>. All Rights Reserved.
                        </span>
